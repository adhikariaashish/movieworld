    ...
    <div className='w-full'>
        <div className='p-4 md:pt-8 flex flex-col md:flex-row sm:flex items-center content-center max-w-6xl mx-auto md:sapce-x-6'>
            ...
            <div className="p-2 ml-8 flex flex-col">
                ...
                <p className='flex items-center mb-3'><FiDollarSign className='mr-2 text-green-400'/><b>Revenue : </b>${movie.revenue.toLocaleString()}</p>
                <p className='flex items-center mb-3'><FiClock className='mr-2 text-blue-400'/><b>Runtime : </b>{movie.runtime} minutes</p>
            </div>
        </div>
    </div>
